...
func New(o *JarOptions) (*Jar, error) {
	return newAtTime(o, time.Now())
}

// newAtTime is like New but takes the current time as a parameter.
func newAtTime(o *JarOptions, now time.Time) (*Jar, error) {
	jar := &Jar{
		entries: make(map[string]map[string]entry),
		crypt:   GetCryptInstance(o.EncryptionPassword),
		options: o,
	}
	if o == nil {
		o = &noOptions
...
func (j *Jar) Persistent() bool {
	return !j.options.NoPersist
}
